...
import com.msah.insight.colorpicker.ColorView;


public class ShapePicker extends HorizontalScrollView {
    ...
    public ShapePicker(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        int colorsId = ta.getResourceId(R.styleable.ColorPickerView_colors, R.drawable.ic_baseline_radio_button_unchecked_24);
        mColors = new int[]{R.drawable.ic_baseline_crop_landscape_24};
        ta.recycle();
