...
public class UserAdapter  extends RecyclerView.Adapter<UserAdapter.ViewHolder>
{
    ...
    public UserAdapter(List<UserModel> listUsers,boolean isChat, Context context, NavController navController)
    {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.itemView.setOnClickListener(v ->
        {
            ...
            {
                navController.navigate(R.id.action_users_to_msg);
            }else
    ...
    private void chooseColorStatus(UserModel user, ViewHolder holder)
    {
