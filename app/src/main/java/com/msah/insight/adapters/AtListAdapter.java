...
public class AtListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.adapter_at_item_view, parent, false);
            viewHolder = new ViewHolder();
            viewHolder.imageView = convertView.findViewById(R.id.view_at_item_image);
            viewHolder.textView = convertView.findViewById(R.id.view_at_item_name);
