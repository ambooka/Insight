package com.msah.insight.render;
...
import com.msah.insight.html.Html;
...
public class ImageGetter implements Html.ImageGetter {
    ...
    public Drawable getDrawable(String source) {
        if (source.startsWith(Constants.EMOJI)) {
            ...
            UrlDrawable areUrlDrawable = new UrlDrawable(mContext);
    ...
    private static class BitmapTarget extends SimpleTarget<Bitmap> {
        private final UrlDrawable areUrlDrawable;
        ...
        public void onResourceReady(Bitmap bitmap, Transition<? super Bitmap> transition) {
            ...
            CustomEditText.stopMonitor();
            textView.setText(textView.getText());
            textView.invalidate();
            CustomEditText.startMonitor();
        }
    }
}
...
//import com.bumptech.glide.request.target.SimpleTarget;
//import com.bumptech.glide.request.transition.Transition;
//import com.msah.insight.Constants;
//import com.msah.insight.Util;
//import com.msah.insight.android.inner.Html;
//import com.msah.insight.spans.AreImageSpan;
//import com.msah.insight.styles.ARE_Image;
