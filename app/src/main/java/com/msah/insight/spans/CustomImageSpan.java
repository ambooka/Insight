...
public class CustomImageSpan extends ImageSpan implements Clickable_Span {
    ...
    public CustomImageSpan(Context context, Bitmap bitmapDrawable, Uri uri) {
        super(context, bitmapDrawable);
        this.mContext = context;
        this.mUri = uri;
    }

    public CustomImageSpan(Context context, Bitmap bitmapDrawable, String url) {
        super(context, bitmapDrawable);
        this.mContext = context;
        this.mUrl = url;
    }

    public CustomImageSpan(Context context, Drawable drawable, String url) {
        super(drawable, url);
        this.mContext = context;
        this.mUrl = url;
    }
