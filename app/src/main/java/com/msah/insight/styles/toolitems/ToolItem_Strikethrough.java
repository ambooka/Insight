...
import com.msah.insight.styles.toolitems.styles.Style_Strikethrough;
import com.msah.insight.utils.Util;
import com.msah.insight.views.CustomEditText;


public class ToolItem_Strikethrough extends ToolItem_Abstract {
    ...
    public IStyle getStyle() {
        if (mStyle == null) {
            ...
            mStyle = new Style_Strikethrough(editText, (ImageView) mToolItemView, toolItemUpdater);
        }
        return mStyle;
    }
