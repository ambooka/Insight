...
public class ListNumber extends ABS_FreeStyle {

    private ImageView mListNumberImageView;

    private boolean toMergeForward = false;

    public ListNumber(ImageView imageView, CustomToolbar toolbar) {
        super(toolbar);
    ...
    protected void changeListBulletSpanToListNumberSpan(Editable editable,
        ...
        ListNumber.reNumberBehindListItemSpans(lastListNumberSpanEnd + 1,
