...
import com.msah.insight.styles.toolitems.styles.Style_Hr;
import com.msah.insight.utils.Util;
import com.msah.insight.views.CustomEditText;

public class ToolItem_Hr extends ToolItem_Abstract {
    ...
    public IStyle getStyle() {
        if (mStyle == null) {
            ...
            mStyle = new Style_Hr(editText, (ImageView) mToolItemView);
        }
        return mStyle;
    }
