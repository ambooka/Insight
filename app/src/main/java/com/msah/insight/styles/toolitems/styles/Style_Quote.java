...
import com.msah.insight.styles.toolitems.IToolItem_Updater;
import com.msah.insight.utils.Util;
import com.msah.insight.views.CustomEditText;

public class Style_Quote implements IStyle {
     ...
     */
    public Style_Quote(CustomEditText editText, ImageView quoteImageView, IToolItem_Updater checkUpdater) {
