package com.msah.insight.styles.toolitems.styles;
...
import com.msah.insight.styles.ABS_FreeStyle;
import com.msah.insight.styles.ListNumber;
import com.msah.insight.utils.Util;
import com.msah.insight.views.CustomEditText;

public class Style_ListBullet extends ABS_FreeStyle {

    private CustomEditText mEditText;

    public Style_ListBullet(CustomEditText editText, ImageView imageView) {
    ...
    private void changeListNumberSpanToListBulletSpan(
        ...
        ListNumber.reNumberBehindListItemSpans(lastListNumberSpanEnd + 1, editable, 0);
