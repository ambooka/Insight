...
public class ToolItem_AlignmentCenter extends ToolItem_Abstract {
    ...
    public IStyle getStyle() {
        if (mStyle == null) {
            ...
            mStyle = new Style_Alignment(editText, (ImageView) mToolItemView, Layout.Alignment.ALIGN_CENTER);
        }
        return mStyle;
    }
