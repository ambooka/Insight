...
public class Style_ListNumber extends ABS_FreeStyle {

    private CustomEditText mEditText;

    private ImageView mListNumberImageView;

    public Style_ListNumber(CustomEditText editText, ImageView imageView) {
    ...
    protected void changeListBulletSpanToListNumberSpan(Editable editable,
        ...
        Style_ListNumber.reNumberBehindListItemSpans(lastListNumberSpanEnd + 1,
