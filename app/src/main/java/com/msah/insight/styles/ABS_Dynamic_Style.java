...
import com.msah.insight.spans.DynamicSpan;
 ...
 * @param <E>
 */
public abstract class ABS_Dynamic_Style<E extends DynamicSpan> extends ABS_Style<E> {

    public ABS_Dynamic_Style(Context context) {
        super(context);
    }
