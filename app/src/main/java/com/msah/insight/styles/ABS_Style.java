...
public abstract class ABS_Style<E> implements IStyle {

    protected Context mContext;

    protected Class<E> clazzE;

    public ABS_Style(Context context) {
        mContext = context;
            ...
            if (end > start) {
                ...
                if (spans.length > 0) {
                    ...
                    if (eStart >= eEnd) {
                        ...
                        setChecked(false);
                        StyleHelper.updateCheckStatus(this, false);
                    } else {
                        //
                ...
                if (spans.length > 0) {
                    ...
                    if (null != span) {
                        ...
                        if (eStart >= eEnd) {
                            ...
                            // UNDERLINE
                            setChecked(true);
                            StyleHelper.updateCheckStatus(this, true);
                        }
                    }
                }
            }
